...
name_rdata!(CNAME, RdataPolicy::StandardRecord);
name_rdata!(NS, RdataPolicy::StandardRecord);
name_rdata!(PTR, RdataPolicy::StandardRecord);
name_rdata!(ANAME, RdataPolicy::Other);
