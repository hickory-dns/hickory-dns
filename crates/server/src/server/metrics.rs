use hickory_proto::op::header::Flags;
use hickory_proto::op::{OpCode, ResponseCode};
use hickory_proto::xfer::Protocol;
use metrics::{Counter, Unit, counter, describe_counter};

#[derive(Clone)]
pub(super) struct ReportingResponseHandlerMetrics {
    pub(super) request_proto: ProtocolMetrics,
    pub(super) request_flags: FlagMetrics,
    pub(super) request_operation: OpCodeMetrics,
    pub(super) response_code: ResponseCodeMetrics,
    pub(super) response_flags: FlagMetrics,
}

impl Default for ReportingResponseHandlerMetrics {
    fn default() -> Self {
        Self {
            request_proto: ProtocolMetrics::default(),
            request_flags: FlagMetrics::new("request"),
            request_operation: OpCodeMetrics::default(),
...
impl FlagMetrics {
    pub(super) fn increment(&self, flags: &Flags) {
