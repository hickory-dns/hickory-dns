...
mod tests {
    ...
    fn test_v4() {
        ...
        access.insert_allow(["192.168.1.0/24".parse().unwrap()].into_iter());
    ...
    fn test_v6() {
        let mut access = AccessControl::default();
        access.insert_allow(["fd00::/120".parse().unwrap()].into_iter());
    ...
    fn test_deny_v4() {
        let mut access = AccessControl::default();
        access.insert_deny(["192.168.1.0/24".parse().unwrap()].into_iter());
    ...
    fn test_deny_v6() {
        let mut access = AccessControl::default();
        access.insert_deny(["fd00::/120".parse().unwrap()].into_iter());
    ...
    fn test_deny_allow_v4() {
        let mut access = AccessControl::default();
        access.insert_deny(["192.168.0.0/16".parse().unwrap()].into_iter());
        access.insert_allow(["192.168.1.0/24".parse().unwrap()].into_iter());
