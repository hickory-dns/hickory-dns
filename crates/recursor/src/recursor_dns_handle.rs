...
use hickory_resolver::name_server::{ConnectionOptions, NameServerOptions, TlsConfig};
...
mod tests {
    ...
    fn test_nameserver_filter() {
        ...
        let builder = Recursor::builder()
            .clear_nameserver_filter()
            .nameserver_filter(allow_server.iter(), deny_server.iter());
