...
**NOTICE** This project was rebranded from Hickory DNS to Hickory DNS and has been moved to the http://github.com/hickory-dns/hickory-dns organization and repo, from `0.24` and onward.
