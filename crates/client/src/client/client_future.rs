...
use proto::xfer::{
    DnsClientStream, DnsExchange, DnsExchangeSend, DnsHandle, DnsMultiplexer,
    DnsMultiplexerSerialResponse, DnsRequest, DnsRequestOptions, DnsRequestSender, DnsResponse,
    DnsStreamHandle,
};
use rand;
