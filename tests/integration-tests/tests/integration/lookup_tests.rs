...
async fn test_mock_lookup() {
    ...
    let message = message_resp(resp_query, vec![v4_record], vec![], vec![]);
...
async fn test_cname_lookup() {
    ...
    let message = message_resp(resp_query, vec![cname_record, v4_record], vec![], vec![]);
    let client: MockClientHandle<_> =
        MockClientHandle::mock(vec![Ok(DnsResponse::from_message(message).unwrap())]);
...
async fn test_chained_cname_lookup() {
    ...
    let message1 = message_resp(resp_query.clone(), vec![cname_record], vec![], vec![]);
    let message2 = message_resp(resp_query, vec![v4_record], vec![], vec![]);
...
async fn test_max_chained_lookup_depth() {
    ...
    // The first response should be a cname, the second will be the actual record
    let message1 = message_resp(resp_query.clone(), vec![cname_record1], vec![], vec![]);
    let message2 = message_resp(resp_query.clone(), vec![cname_record2], vec![], vec![]);
    let message3 = message_resp(resp_query.clone(), vec![cname_record3], vec![], vec![]);
    let message4 = message_resp(resp_query.clone(), vec![cname_record4], vec![], vec![]);
    let message5 = message_resp(resp_query.clone(), vec![cname_record5], vec![], vec![]);
    let message6 = message_resp(resp_query.clone(), vec![cname_record6], vec![], vec![]);
    let message7 = message_resp(resp_query.clone(), vec![cname_record7], vec![], vec![]);
    let message8 = message_resp(resp_query.clone(), vec![cname_record8], vec![], vec![]);
    let message9 = message_resp(resp_query.clone(), vec![cname_record9], vec![], vec![]);
    let message10 = message_resp(resp_query, vec![v4_record], vec![], vec![]);
...
async fn test_forward_soa() {
    ...
    let message = message_resp(resp_query.clone(), vec![], vec![soa_record], vec![]);
...
async fn test_forward_ns() {
    ...
    let message = message_resp(resp_query.clone(), vec![], vec![ns1], vec![]);
