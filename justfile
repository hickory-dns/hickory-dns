...
h3-aws-lc-rs: (default "--features=h3-aws-lc-rs" "--ignore=\\{hickory-proto,test-support,test-server\\}")
...
h3-ring: (default "--features=h3-ring" "--ignore=\\{hickory-proto,test-support,test-server\\}")
