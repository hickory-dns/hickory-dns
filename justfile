...
dns-over-openssl: (default "--features=dns-over-openssl" "--ignore=\\{async-std-resolver,hickory-compatibility,hickory-dns,hickory-integration,hickory-recursor,hickory-server,hickory-util,test-support\\}")

# Check, build, and test all crates with dnssec-openssl enabled
dnssec-openssl: (default "--features=dnssec-openssl" "--ignore=\\{async-std-resolver,hickory-compatibility,hickory-dns,hickory-integration,hickory-recursor,hickory-server,hickory-util,test-support\\}")
