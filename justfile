...
tls-aws-lc-rs: (default "--features=tls-aws-lc-rs" "--ignore=\\{hickory-proto,hickory-dnstap,test-support,test-server\\}")

# Check, build, and test all crates with https-aws-lc-rs enabled
https-aws-lc-rs: (default "--features=https-aws-lc-rs" "--ignore=\\{hickory-proto,hickory-dnstap,test-support,test-server\\}")

# Check, build, and test all crates with quic-aws-lc-rs enabled
quic-aws-lc-rs: (default "--features=quic-aws-lc-rs" "--ignore=\\{hickory-proto,hickory-dnstap,test-support,test-server\\}")

# Check, build, and test all crates with h3-aws-lc-rs enabled
h3-aws-lc-rs: (default "--features=h3-aws-lc-rs" "--ignore=\\{hickory-proto,hickory-dns,hickory-client,hickory-dnstap,test-support,test-server\\}")

# Check, build, and test all crates with tls-ring enabled
tls-ring: (default "--features=tls-ring" "--ignore=\\{hickory-proto,hickory-dnstap,test-support,test-server\\}")

# Check, build, and test all crates with https-ring enabled
https-ring: (default "--features=https-ring" "--ignore=\\{hickory-proto,hickory-dnstap,test-support,test-server\\}")

# Check, build, and test all crates with quic-ring enabled
quic-ring: (default "--features=quic-ring" "--ignore=\\{hickory-proto,hickory-dnstap,test-support,test-server\\}")

# Check, build, and test all crates with h3-ring enabled
h3-ring: (default "--features=h3-ring" "--ignore=\\{hickory-proto,hickory-dns,hickory-client,hickory-dnstap,test-support,test-server\\}")

# Check, build, and test all crates with dnssec-aws-lc-rs enabled
dnssec-aws-lc-rs: (default "--features=dnssec-aws-lc-rs" "--ignore=\\{hickory-dnstap,test-support,test-server\\}")

# Check, build, and test all crates with dnssec-ring enabled
dnssec-ring: (default "--features=dnssec-ring" "--ignore=\\{hickory-dnstap,test-support,test-server\\}")
