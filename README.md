...
| [**Net**](crates/net/)              | [![](https://img.shields.io/crates/v/hickory-net.svg)](https://crates.io/crates/hickory-net) [![hickory-net](https://docs.rs/hickory-net/badge.svg)](https://docs.rs/hickory-net) Implementations of DNS transport protocols, DNSSEC support, and a DNS client.                                                 |
