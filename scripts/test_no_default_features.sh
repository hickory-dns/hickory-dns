...
# Build all tests
cargo test --manifest-path crates/proto/Cargo.toml --no-default-features
...
cargo test --manifest-path crates/resolver/Cargo.toml --no-default-features
cargo test --manifest-path crates/resolver/Cargo.toml --no-default-features --features tokio-runtime
